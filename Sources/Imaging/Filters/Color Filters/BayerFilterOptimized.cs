...
namespace AForge.Imaging.Filters
{
    ...
    /// optimized for one of the common patterns, which is
    /// <code lang="none">
    /// G R
    /// B G
    /// </code>
    /// Also the class processes images with even width and height only. Image size must be at least 2x2 pixels.
    /// </para>
    /// 
