...
namespace AForge.Imaging.Filters
{
    ...
    public class TransformToPolar : BaseTransformationFilter
    {
        ...
        /// be extended into the direction of edges). Changing the property from 0 to 1 user may balance
        ...
        /// </summary>
        /// 
        /// <remarks><para>The property specifies position of source image's top line in the destination
        ...
        protected override unsafe void ProcessFilter( UnmanagedImage sourceData, UnmanagedImage destinationData )
        {
            ...
            for ( int y = 0; y < newHeight; y++ )
            {
                ...
                for ( int x = 0; x < newWidth; x++ )
                {
                    ...
                    double maxAllowedDistance = radius + ( maxDistance - radius ) * ( 1 - circleDepth );
