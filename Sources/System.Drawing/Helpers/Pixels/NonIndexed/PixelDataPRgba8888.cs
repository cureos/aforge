...
namespace ImagePixelEnumerator.Helpers.Pixels.NonIndexed
{
    ...
    internal struct PixelDataPRgba8888 : INonIndexedPixel
    {
        // raw component values
        [FieldOffset(1)] private readonly Byte alphaBlue;  // 08 - 15
        [FieldOffset(2)] private readonly Byte alphaGreen; // 16 - 23
        [FieldOffset(3)] private readonly Byte alphaRed;   // 24 - 31
        [FieldOffset(0)] private readonly Byte alpha;      // 00 - 07
