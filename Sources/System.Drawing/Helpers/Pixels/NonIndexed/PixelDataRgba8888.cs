...
namespace ImagePixelEnumerator.Helpers.Pixels.NonIndexed
{
    ...
    internal struct PixelDataRgba8888 : INonIndexedPixel
    {
        // raw component values
        [FieldOffset(1)] private readonly Byte blue;  // 08 - 15
        [FieldOffset(2)] private readonly Byte green; // 16 - 23
        [FieldOffset(3)] private readonly Byte red;   // 24 - 31
