...
namespace AForge.Math
{
    ...
    public struct Vector3
    {
        ...
        /// </summary>
        /// 
        /// <param name="vector1">Vector to add the specified value to.</param>
        ...
        /// <returns>Returns new vector with all coordinates increased by the specified value.</returns>
        /// 
        public static Vector3 Add( Vector3 vector1, float value )
        {
        ...
        /// </summary>
        /// 
        /// <param name="vector1">Vector to subtract the specified value from.</param>
        ...
        /// <returns>Returns new vector with all coordinates decreased by the specified value.</returns>
        /// 
        public static Vector3 Subtract( Vector3 vector1, float value )
        {
            return vector1 - value;
        }
