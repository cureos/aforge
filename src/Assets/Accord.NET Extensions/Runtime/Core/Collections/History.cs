...
namespace Accord.Extensions
{
    ...
    public class History<T> : ICloneable, IEnumerable<T>, IEnumerator<T>
    {
        ...
        public History(int maxNumOfElems = int.MaxValue)
        { 
        ...
        {
            int maxDepth = System.Math.Max(this.histElems.Count - maxHistDepth, 0);
        ...
        public void RemoveRange(int startDepth, int numOfElems)
        {
            ...
            int index = System.Math.Max(this.histElems.Count - 1 - startDepth - numOfElems, 0);
			int count = System.Math.Min(numOfElems, this.histElems.Count - 1 - index);
