        ...
        public KappaTest(
            ...
            else
            {
				...
				public KappaTest(
					...
					WeightedConfusionMatrix weightedMatrix = matrix as WeightedConfusionMatrix;
					...
					} else if (hypothesizedKappa == 0){
						// Use the null hypothesis variance
						Compute(weightedMatrix.WeightedKappa, hypothesizedKappa, weightedMatrix.WeightedStandardErrorUnderNull, alternate);
						Variance = weightedMatrix.WeightedVarianceUnderNull;
					} else {
						// Use the default variance
						Compute(weightedMatrix.WeightedKappa, hypothesizedKappa, weightedMatrix.WeightedStandardError, alternate);
						Variance = weightedMatrix.WeightedVariance;
					}
				}
