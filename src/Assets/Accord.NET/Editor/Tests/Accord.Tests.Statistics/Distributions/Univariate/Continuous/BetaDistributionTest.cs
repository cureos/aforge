...
namespace Accord.Tests.Statistics
{
    ...
    public class BetaDistributionTest
    {
        ...
        public void BetaMeanTest()
        {
			...
			Assert.AreEqual(0.21105527638190955, mean, 1e-10);
			Assert.AreEqual(0.11577706212908731, median, 1e-10);
			Assert.AreEqual(0.055689279830523512, var, 1e-10);
			Assert.AreEqual(1.1828193992944409, chf, 1e-10);
			Assert.AreEqual(0.69358638272337991, cdf, 1e-10);
			Assert.AreEqual(0.94644031936694828, pdf, 1e-10);
			Assert.AreEqual(-0.055047364344046057, lpdf, 1e-10);
			Assert.AreEqual(3.0887671630877072, hf, 1e-10);
			Assert.AreEqual(0.30641361727662009, ccdf, 1e-10);
