...
namespace Accord.Tests.Statistics
{
    ...
    public class TwoSampleZTestTest
    {
        ...
        public void TwoSampleZTestConstructorTest()
        {
			...
			TwoSampleZTest actual = new TwoSampleZTest(samples1, samples2, 0.0);
			...
			TwoSampleZTest expected = new TwoSampleZTest(mean1, var1, n1, mean2, var2, n2, 0.0);
        ...
        public void TwoSampleZTestConstructorTest1()
        {
			...
			TwoSampleZTest target = new TwoSampleZTest(mean1, var1, samples1, mean2, var2, samples2, 0.0);
