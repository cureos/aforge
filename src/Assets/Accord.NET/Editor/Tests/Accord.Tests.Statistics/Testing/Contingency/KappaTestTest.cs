...
namespace Accord.Tests.Statistics
{
    ...
    public class KappaTestTest
    {
        ...
        public void KappaTestConstructorTest()
        {
			...
			KappaTest target = new KappaTest(a, 0, OneSampleHypothesis.ValueIsDifferentFromHypothesis);
        ...
        public void KappaTestConstructorTest4()
        {
			...
			KappaTest target = new KappaTest(a, 0.8, OneSampleHypothesis.ValueIsDifferentFromHypothesis);
